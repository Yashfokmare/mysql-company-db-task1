...
SELECT *
FROM movies
WHERE production_company = 'Hombale Films';
SELECT *
FROM movies
WHERE production_company = 'Arka Media Works';
SELECT *
FROM movies
ORDER BY views DESC
LIMIT 5;
...
SELECT *
FROM movies
ORDER BY production_company ASC, rating DESC;
SELECT *
FROM movies
WHERE release_year > 2015
ORDER BY rating DESC
...
SELECT *
FROM movies
WHERE director LIKE '%Raj%';
SELECT *
FROM movies
WHERE production_company LIKE '%Films%';
SELECT *
FROM movies
...
SELECT *
FROM movies
WHERE language IN ('Hindi', 'Telugu');
SELECT *
FROM movies
WHERE genre = 'Action'
AND views > 1000000;
